...
class Env:
  ...
  def interactive_run(self, model: tf.keras.Model) -> None:
    ...
    while is_running:
      ...
      action_text = "model output : {}"

      fps_text_surface = font.render(fps_text, True, (0, 0, 0))
      info_text_surface = font.render(info_text, True, (0, 0, 0))
      action_text_surface = font.render(action_text.format(all_actions_names[action] if not tilt else "none"),
                                        True, (0, 0, 0))
      lr_r_surface = font.render(lr_r_text, True, (51, 255, 51) if tilt and direction == 1 else (255, 51, 51))
      lr_l_surface = font.render(lr_l_text, True, (51, 255, 51) if tilt and direction == 0 else (255, 51, 51))
      ...
      window.blit(action_text_surface, (10, 50))
